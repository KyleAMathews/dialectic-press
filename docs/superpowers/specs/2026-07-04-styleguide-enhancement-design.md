...
7. **Writing motivation not surfaced** — Phase 1 asks what you're wrestling with, but not WHY you're writing this piece, which shapes everything downstream
...
**Add: "Why Are You Writing This?" Interview**

The dialectic surfaces what you're wrestling with, but not why you're writing about it. This shapes everything downstream. After reading the dialectic outputs, interview the user:
...
**Community-Finding (blogging research):**
...
7. **Writing motivation shapes craft** — why you're writing determines voice, density, stakes
