...
The dialectic operates *within* a domain. The sloptractions essay needs to *map that domain onto another* to create leverage. Find the right analogical domain.

## Why Analogies Matter

The best sloptractions essays aren't just arguments — they're reframings. Rao doesn't just argue about LLM writing; he maps it onto index funds vs. active management. The analogy does conceptual work:
...
- **Memeing as hyperstition** — both involve belief becoming real through collective action

A good analogy:
- Is **structural, not superficial** — the systems actually work similarly
- **Does work** — removing the analogy would collapse the argument
- **Imports vocabulary** — terms from the analogical domain become conceptual currency
...
> "The dialectic's structure suggests several possible analogical domains:
> 
> **Option A: [Domain]**
